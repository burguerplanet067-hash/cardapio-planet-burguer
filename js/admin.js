...
(function () {
  ...
  function defaultDraft() {
    return {
      ...
      deliveryFeeText: DELIVERY_FEE_TEXT,
  ...
  function renderStore() {
    ...
    if (!draft.deliveryFeeMode) draft.deliveryFeeMode = DELIVERY_FEE_MODE;
    if (!draft.deliveryFeeText) draft.deliveryFeeText = DELIVERY_FEE_TEXT;
    ...
    document.getElementById("storeFacebook").value = draft.storeInfo.facebook || "";
    ...
    document.getElementById("deliveryFeeModeField").value = draft.deliveryFeeMode;
  ...
  document.getElementById("deliveryFeeModeField").addEventListener("change", (e) => {
    draft.deliveryFeeMode = e.target.value;
    saveDraft();
  });
  ...
  document.getElementById("storeFacebook").addEventListener("input", (e) => {
    draft.storeInfo.facebook = e.target.value;
    saveDraft();
  });
...
const STORE_INFO = {
  ...
  facebook: ${jsString(d.storeInfo.facebook || "")},
...
const DELIVERY_FEE_MODE = ${jsString(d.deliveryFeeMode || "consultar")}; // "consultar" ou "fixo"
const DELIVERY_FEE_TEXT = ${jsString(d.deliveryFeeText || "a consultar")};
